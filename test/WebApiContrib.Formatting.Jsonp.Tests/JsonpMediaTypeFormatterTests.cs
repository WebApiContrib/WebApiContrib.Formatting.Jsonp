...
namespace WebApiContrib.Formatting.Jsonp.Tests
{
    public class JsonpMediaTypeFormatterTests
    {
        ...
        [TestCase("/api/value/1?callback=?", "", "application/json", "\"value 1\"")]
        [TestCase("/api/value/1?callback=?", "application/json", "application/json", "\"value 1\"")]
        // text/javascript
        [TestCase("/api/value/1?callback=?", "text/javascript", "text/javascript", "?(\"value 1\");")]
        [TestCase("/api/value/1?format=jsonp&callback=?", "", "text/javascript", "?(\"value 1\");")]
        [TestCase("/api/value/1", "text/javascript", "text/javascript", "A callback parameter was not provided in the request URI.")]
        // application/javascript
        [TestCase("/api/value/1?callback=?", "application/javascript", "application/javascript", "?(\"value 1\");")]
        [TestCase("/api/value/1", "application/javascript", "application/javascript", "A callback parameter was not provided in the request URI.")]
        // application/json-p
        [TestCase("/api/value/1?callback=?", "application/json-p", "application/json-p", "?(\"value 1\");")]
        [TestCase("/api/value/1", "application/json-p", "application/json-p", "A callback parameter was not provided in the request URI.")]
        // Ignore due to failure: UriExtensionMapping
        //[TestCase("/api/value/1/jsonp?callback=?", "", "text/javascript", "?(\"value 1\");")]
